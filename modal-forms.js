function register_modal_actions(modal)
{
    ...
    modal.find('.modal-form-delete').on({
        ...
        'click': function() {
            ...
            var jq_this = $(this);
            confirm_message = jq_this.attr('data-confirm-message');
            if (!confirm_message) {
                confirm_message = "Are you sure you want to delete?";
            }
            UIkit.modal.confirm(confirm_message, function(){
...
{
    // Load the form
    var form_url = button.attr('data-form-url');
    var modal_selector = button.attr('href');
